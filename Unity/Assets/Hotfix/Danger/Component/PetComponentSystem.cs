...
namespace ET
{
    ...
    public static class PetComponentSystem
    {
        ...
        public static async ETTask RequestXiLian(this PetComponent self, long itemId, long petId, bool addnumber)
        {
            C2M_RolePetXiLian c2M_RolePetXiLian = new C2M_RolePetXiLian() { BagInfoID = itemId, PetInfoId = petId, CostItemNum = 1, AddNumber = addnumber };
